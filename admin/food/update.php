...
<?php include('../../utils/food/get_food.php'); ?>
...
<div class="ml-[20%]">
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <h2 class="mb-4 text-xl font-bold text-gray-900 ">Update existing food</h2>
            <form action="<?php echo $url.'utils/food/food_update.php';?>" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="food_name" id="food_name"
                            ...
                            placeholder="Type Food Name" value="<?php echo $food['name']; ?>" required="">
                    </div>
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="food_description" rows="8" name="food_desc"
                            ...
                            placeholder="Your description here"><?php echo $food['description']; ?></textarea>
                    </div>
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="food_price" id="food_price"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            placeholder="Type Food Name" value="<?php echo $food['price']; ?>" required="">
                    </div>
                    <div class="sm:col-span-2">
                        ...
                        <input type="file" name="food_img" id="food_img"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            placeholder="Type Food Name" value="<?php echo $food['image']; ?>" required="">
                    </div>
                </div>
                <button type="submit"
