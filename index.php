...
<body class="bg-gradient-to-r from-white to-[#aeafb8]">
    <header>
        <nav class="border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="https://flowbite.com" class="flex items-center">
                    <img src="assets/images/logo.png" class="mr-3 h-9 sm:h-16" alt="" />
                </a>
                <div class="md:hidden block flex items-center lg:order-2">
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Sign In/Sign Up</a>
                        </li>
                        <li>
                            <a href="#" class="flex space-x-2 py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">
                                <span>Cart</span>
                                <img src="assets/images/food-cart.png" width="20" alt="">
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <section class="h-full my-10">
        <div class="flex justify-between items-center">
            <div class="flex justify-between flex-col w-full mx-10 space-y-5">
            ...
            <img src="assets/images/pexels-ella-olsson-1640777.jpg" class="h-auto w-1/2" />
        </div>
    </section>
</body>